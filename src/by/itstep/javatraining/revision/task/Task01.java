...
public class Task01 {
    public static int task01(int hour1, int minute1, int second1, int hour2, int minute2, int second2) {
        ...
        int rez = (hour2 - hour1) * 3600 + (minute2 - minute1) * 60 + second2 - second1;

        return hour1 < 0 || hour2 < 0 || minute1 < 0 || minute2 < 0 || second1 < 0 || second2 < 0 ||
                hour1 > 23 || hour2 > 23 || minute1 > 59 || minute2 > 59 || second1 > 59 || second2 > 59 ?
                -1 : rez < 0 ?
                rez * -1 : rez;
//        return hour1 < 0 || hour2 < 0 || minute1 < 0 || minute2 < 0 || second1 < 0 || second2 < 0 ||
//                hour1 > 23 || hour2 > 23 || minute1 > 59 || minute2 > 59 || second1 > 59 || second2 > 59 ?
//                -1 : ((hour2 - hour1) * 3600 + (minute2 - minute1) * 60 + second2 - second1) < 0 ?
//                ((hour2 - hour1) * 3600 + (minute2 - minute1) * 60 + second2 - second1) * -1 :
